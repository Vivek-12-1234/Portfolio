...
**[A/B Testing – Marketing Campaign Analysis](https://github.com/Vivek-12-1234/AB_Testing_Marketing_Campaign_Analysis)**  
An end-to-end **A/B testing project** focused on evaluating marketing campaign performance using **statistical hypothesis testing**. The analysis compares **control and treatment groups** to determine whether campaign changes led to **statistically significant improvements** in customer engagement or conversions.
